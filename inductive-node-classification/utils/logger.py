...
def train_log(logger, config):
    logger.log(f'lr={config.train.lr} diffusion_steps={config.diffusion.step} schedule={config.train.lr_schedule} weight_decay={config.train.weight_decay} '
               f'skip={config.model.skip}')
